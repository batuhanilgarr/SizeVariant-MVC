...
public class SpecialUsageModel
{
    public string? Code { get; set; }
    public string? Description { get; set; }
    public DateTime? ModifiedTime { get; set; }

    public static SpecialUsageModel FromJson(JsonElement element)
    {
        ...
        return new SpecialUsageModel { Code = code, Description = desc, ModifiedTime = mod };
    }
}
